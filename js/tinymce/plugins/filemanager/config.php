<?php
	...
	if(isset($_SESSION['userid']) && $_SESSION['user']['admin_login']=='1'){
	...
	$mcFileManagerConfig['general.tools'] = "createdir,refresh,zip,upload,cut,copy,paste,delete,selectall,unselectall,view,download,addfavorite,removefavorite";
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,png,swf,dcr,mov,avi,mpg,mpeg,asf,flv,pdf";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,swf,dcr,mov,avi,mpg,mpeg,asf,flv,pdf";
	...
	$mcFileManagerConfig['download.extensions'] = "gif,jpg,png,swf,dcr,mov,avi,mpg,mpeg,asf,flv,pdf";
	...
	$mcFileManagerConfig['edit.extensions'] = "txt";
